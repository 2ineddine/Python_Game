...
class Game:
    ...
    def select_units(self, player_number):
        ...
        while len(selected_units) <2:  # Chaque joueur choisit 4 unités
                            ...
                            # Phase d'attaque sur la cible
                                ...
                                if event.key == pygame.K_a:
                                    ...
                                    for effect_cell in effect_zone:
                                        ...
                                        for target in self.player1_units + self.player2_units:
    ...
    unit=None
        ...
        pygame.display.set_caption("okkkkk")
        image =pygame.image.load("E:\Projet jeu python\jeux\gridimage\gride.webp")
        ...
        if selected_units is not None and player_choice is not None:
            ...
            #phase de jeu 
            instruction=font.render(f"Phase de jeu",True,(255,255,0))
            ...
            for x in range(0, WIDTH, CELL_SIZE):
                for y in range(0, HEIGHT, CELL_SIZE):
                    ...
                    """
            for players in unit.__class__.__name__:
                
                pygame.draw.rect(self.screen,BLUE,
                                    (unit.x*CELL_SIZE,unit.y*CELL_SIZE,CELL_SIZE,CELL_SIZE),4)
