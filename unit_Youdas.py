...
class Alexandria (Unit):
    ...
    def Illusion_lumiuneuse(self,target):
        puissance=70
        precision=0.80
        att_range=1
        crit_rate=0.15
    ...
    def sp_epee_de_legende(self,target):
        puissance = 100
        precision = 1
        crit_rate = 0.05
        att_range=1
...
class Cammuvravi (Unit):
    #Classe pour l'unité Cammuvravi
    ...
    def sp_salve_divine(self,target):
        ...
        self.attack(target,puissance,precision,crit_rate,att_range)
        #ajouter zone d'effet
        # faut ajouter un effet de brulure sur l'ennemi touché
...
class Mio (Unit):
    ...
    def SP_attaque_jumelee(self,target):
        puissance=80
        precision=1
        att_range=1
        crit_rate=0.01
