                ...
                if event.type == pygame.KEYDOWN:
                    ...
                    if in_movement_phase and has_moved==False:
                        ...
                        if event.key == pygame.K_SPACE:
                            ...
                            if (unit.x , unit.y) in poison_cell:
                                ...
                                print(f"{unit.__class__.__name__} est sur une case poison et devient donc empoisonné pendant 3 tours !")
                                if unit.health<=1  :
                    ...
                    # Phase d'attaque
                        ...
                        if event.key == pygame.K_1:
                            self.skill_select.selected_skill_index = 0  # La première compétence (index 0)
